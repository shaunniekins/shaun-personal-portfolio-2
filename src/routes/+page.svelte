<script lang="ts">
  ...
  $: totalPages = Math.ceil(portfolioData.projects.items.length / itemsPerPage);
  $: paginatedProjects = portfolioData.projects.items.slice(
...
>
      ...
      <div class="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
        ...
        >
          ...
          <div class="flex space-x-4">
            {#each portfolioData.contact.socials.filter((social) => social.icon === "github" || social.icon === "linkedin") as social (social.name)}
              <a
                href={social.url}
                target="_blank"
                rel="noopener noreferrer"
                aria-label={social.name}
                class="text-purple-300 hover:text-purple-100 transition-colors transform hover:scale-110 p-2 glass-card rounded-full"
              >
  ...
  >
    ...
    <div class="container mx-auto px-6 relative z-10">
      <h2
        class={`text-4xl font-bold text-center text-white ${portfolioData.projects.title === "Featured Projects" ? "mb-8" : "mb-16"}`}
        transition:slide={{ delay: 200 }}
      >
      ...
      {#if totalPages > 1}
        <div class="flex justify-center mb-8 space-x-2">
          ...
          <button
            ...
            class="px-4 py-2 rounded-lg glass-card text-purple-300 hover:text-purple-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          {#each Array(totalPages) as _, i}
            ...
            <button
              ...
              class="px-4 py-2 rounded-lg transition-all duration-300 {currentPage ===
              pageNum
                ? 'bg-purple-600 text-white shadow-lg'
                : 'glass-card text-purple-300 hover:text-purple-100 hover:bg-purple-600 hover:bg-opacity-30'}"
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {#each paginatedProjects as project, i (project.name)}
          <div
